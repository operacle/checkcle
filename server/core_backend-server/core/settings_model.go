...
type settings struct {
	...
	SettingsEncryption SettingsEncryptionConfig `form:"settingsEncryption" json:"settingsEncryption"`
}

type SettingsEncryptionConfig struct {
...
func (s *Settings) DBExport(app App) (map[string]any, error) {
	...
	if encryptionKey != "" && s.settings.SettingsEncryption.Enabled {
